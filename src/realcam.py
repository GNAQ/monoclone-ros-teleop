# This module should be moved to m7e_drl after preliminary test.
import numpy as np
import cv2
...
class RSCamera:
    ...
    def _resize(self, img):
        return cv2.resize(img, (self._width, self._height), interpolation=cv2.INTER_AREA)
    ...
    def _connect_cam(self):
        ...
        print('[RSCam] Cam connected with arguments : ')

    @staticmethod
    def scale_to_255(frame):
    ...
    def get_frame(self):
        ...
        if not aligned_depth_frame or not aligned_color_frame:
            print("ERROR: no new images received !")
            return
